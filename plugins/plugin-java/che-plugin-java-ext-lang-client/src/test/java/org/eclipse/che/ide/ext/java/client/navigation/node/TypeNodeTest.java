...
public class TypeNodeTest {
    private final static String BINARY_CLASS_PATH = "path.class";
    private final static String SOURCE_CLASS_PATH = "path/class.java";
    ...
    @Mock
    private Promise<List<Node>> promise;

    @Captor
    private ArgumentCaptor<AsyncPromiseHelper.RequestCall<List<Node>>> callArgumentCaptor;
