...
public class JavaExtension {
	...
	public static final  String JAVA_OVERRIDABLE_METHODS    = "javaOverridableMethods";
    ...
    private void prepareActions(NewPackageAction newPackageAction,
		...
		actionManager.registerAction(JAVA_OVERRIDABLE_METHODS, overridableMethodsAction);
